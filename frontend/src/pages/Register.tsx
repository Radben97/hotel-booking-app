      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col md:flex-row gap-5">
              <label className="text-gray-700 text-sm font-bold flex-1">
                  ...
                  border-blue-500 rounded w-full py-1 px-2 font-normal" {...register("firstname", { required: "This field is required" })} />
                  {errors.firstname && (
              ...
              <label className="text-gray-700 text-sm font-bold flex-1">
                  Last Name
                  <input type="text" className="border-2
                  border-blue-500 rounded w-full py-1 px-2 font-normal" {...register("lastname", { required: "This field is required" })} />
                  {errors.lastname && (
              ...
              <label className="text-gray-700 text-sm font-bold flex-1">
                  Confirm Password
                  <input type="password" className="border-2
                  border-blue-500 rounded w-full py-1 px-2 font-normal" {...register("confirmPassword", {
                      validate: (val) => {
